...
---
<!-- trackio-cell
{"type": "markdown", "id": "cell_42f9cba43e4a", "created_at": "2026-07-19T17:01:38+00:00", "title": "Executive summary", "pinned": true, "pinned_at": "2026-07-19T17:01:38+00:00"}
-->
**C1 and C2 verify; C5 is falsified as written.** The Fourier/translation identity passes 7,680 rotary and 192 finite Parseval/Riesz cases, while the regular-simplex/economy construction passes 7,936 symmetry trials, 64 independent optimizations, and 15 negative controls. The released 85.97-mIoU entrypoint is conclusively ShapeNetPart (16 categories, 50 parts), not the anchored ModelNet40 benchmark; C3, C4, and empirical C6 remain inconclusive because the release has no checkpoints and no SemanticKITTI code. This CPU-only audit took seconds and cost $0; it does not substitute a reduced benchmark for the paper's four-A100 training program.

## Scope & cost

|  | This reproduction | Full replication |
| --- | --- | --- |
| Scope | Exact C1/C2 certificates; source-level C5 falsification; C3/C4/C6 audit | 400-epoch ImageNet; rotation; 15-epoch Kinetics; 200/50-epoch point-cloud runs and ablations |
| Hardware | Apple M2 CPU | Paper: 4x NVIDIA A100 40 GB |
| Compute time | Seconds for captured runs | Multi-pipeline, multi-day training |
| Cost | $0 | Current 4xA100 HF rate $10/hour plus data/storage |
| Outcome | C1/C2 verified; C5 falsified; C3/C4/C6 unresolved | Needed to adjudicate exact empirical metrics |


---
<!-- trackio-cell
{"type": "figure", "id": "cell_84eaa6efe1a0", "created_at": "2026-07-19T17:25:27+00:00", "title": "Reproduction poster (poster_embed.html)", "pinned": true, "pinned_at": "2026-07-19T17:25:28+00:00"}
-->
````html
<!DOCTYPE html>
<!-- poster_embed.html -->
<!-- DESIGN DIRECTION (Step 2.5, locked)
  concept:        reciprocal-space evidence atlas -- two exact certificates, one benchmark-identity falsification
  axis1 layout:   hero panel 1.5fr+1fr; focal: the six-claim adjudication map
  axis2 canvas:   warm near-white, flat, full
  axis3 palette:  reciprocal blue #245C7A, audit red #C04A43
  axis4 type:     serif body + sans headings; mono-free technical report
  axis5 density:  balanced
  axis6 card:     white surface, thin colored frame, restrained shadow
  axis7 heading:  numbered joint with concise claim headings
  axis8 masthead: centered report masthead; compact evidence footer
  devices:        verdict scoreboard, four-part evidence strip
  hero moment:    proof-to-source-audit evidence map -- the only loud element
...
<!--
  ...
  HOW TO USE:
    ...
    2. Edit the DESIGN TOKENS in `:root` (re-theming mechanics: templates/THEMES.md) —
       the token block is the ONLY place color/font-size literals may live.
    3. Replace scaffold content with paper-specific evidence. The hero is the
       only "big" element — put your headline figure / table / diagram there.
    4. Run `python3 tools/run_gates.py poster.html --tokens design_tokens.json` (the default driver:
       preflight -> style -> measure -> polish; design_tokens.json is the
       design-direction pack written at lock time -- SKILL.md Step 2.5) to verify the
...
<title>Reproduction: nD-RoPE — ICML 2026</title>
...
<style>
  ...
  :root {
    ...
    /* The ONLY place color / font-size literals are allowed (style_check
       ...
       To rebrand, edit these (re-theming mechanics: templates/THEMES.md). */
    ...
    --emph:          #C04A43;
    --emph-soft:     #F8EAE8;
    --emph-ink:    #FFFFFF;  /* ink ON the emphasis fill. NOT var(--accent-deep):
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .poster {
    ...
    grid-template-rows: auto minmax(0, 1fr) auto auto;   /* header | hero-grid | takeaways | footer. minmax(0,1fr) (not bare 1fr): an over-tall body compresses instead of pushing takeaways/footer off-canvas */
    gap: calc(6 * var(--u));
  ...
  /* SUPPORTING column — fixed gaps keep every whitespace interval honest. */
  .column {
    display: flex;
    flex-direction: column;
  ...
  /* Continuous, one-line alignment lever on the final evidence card. */
  .column .card:last-child { padding-bottom: calc(12 * var(--u)); }
  ...
  /* Callout: solid accent for primary; solid emphasis fill for theorems / "★ key" strips
     (emph .callout de-gradiented to a flat fill). */
  .callout {
    background: var(--accent);
  ...
  .hero-grid > .column { min-width: 0; }  /* this template's body is .hero-grid (no .body-grid) — a .body-grid selector here would never match and the guard would be dead */
  .card { min-width: 0; }
...
<div class="poster" data-measure-role="poster">
  ...
  <header class="header" data-measure-role="header">
    ...
    <div class="title-block">
      <h1 class="title"><span class="accent">nD-RoPE</span>: A Generalized RoPE for n-Dimensional Position Embedding</h1>
      <div class="subtitle">Independent Fourier/simplex certificates and an adversarial audit of the released empirical pipelines.</div>
      <div class="authors-line">
        <span class="author">Boyang Li</span> &middot;
        <span class="author">Yulin Wu</span> &middot;
        <span class="author">Sizhe Xu et al.</span>
        <span class="aff">Paper authors &middot; reproduction audit by DineshAI</span>
      </div>
    </div>

    <!-- No logo or QR was supplied; keep the balanced third header track empty. -->
    <div class="right-block" aria-hidden="true"></div>
  </header>
  ...
  <div class="hero-grid" data-measure-role="body">
    ...
    <section class="hero" data-measure-role="hero">
      ...
      <div class="section-title"><span class="num">1</span><span class="st-text">From reciprocal-space proof to benchmark identity&nbsp;<span class="tag-key">&#9733; evidence, not table transcription</span></span></div>
      ...
      <div class="hero-stage">
        <img src="data:image/svg+xml;base64,"
             alt="Six-claim evidence map showing two verified mathematical claims, a falsified benchmark identity, and three unresolved empirical claims">
      </div>

      <!-- Optional caption directly under the hero. -->
      <div class="hero-caption">
        <strong>Reproduction evidence map.</strong> Exact Fourier and simplex certificates resolve C1/C2; executable dataset paths falsify C5 as written; missing checkpoints bound C3/C4/C6.
      </div>
      ...
      <div class="hero-aside">
        The clean-room checks instantiate the paper's equations directly and then execute the pinned author functions for parity. The empirical audit scans all 154 released files, full Git history, Hub assets, the only fork, and local caches without promoting reported tables to reproduced measurements.
      </div>
    ...
    <div class="column" data-measure-role="column">
      ...
      <div class="card highlight" data-measure-role="card" data-logbook-target="claim-1-fourier-hilbert-derivation">
        <div class="section-title"><span class="num">2</span><span class="st-text">C1 &mdash; Fourier/Hilbert derivation</span></div>
        <p class="body-text">
          A finite Fourier analogue checks Parseval transfer, kernel preservation, multiplicative phase modulation, and displacement-only attention. The pinned author implementation is evaluated verbatim through an AST-isolated parity harness.
        </p>
        <ul class="mt-3 fs-4">
          <li><strong>7,680</strong> rotary translation/displacement identities.</li>
          <li><strong>192</strong> finite Parseval, relative-shift, and Riesz cases.</li>
          <li>Worst mathematical error: <strong>4.46&times;10<sup>&minus;14</sup></strong>.</li>
        </ul>
      </div>

      <div class="card" data-measure-role="card" data-logbook-target="claim-2-simplex-geometry-and-optimal-scale">
        <div class="section-title"><span class="num">3</span><span class="st-text">C2 &mdash; simplex geometry and scale</span></div>
        <p class="body-text">
          The regular simplex is checked from dimension 2 through 32 for rank, centroid, Gram geometry, tight-frame energy, and permutation symmetry. A separate scalar optimizer tests the economy principle.
        </p>
        <div class="eqn">
          <span class="label">Economy optimum</span>
          $$\rho=r^n=e \quad\Longrightarrow\quad r^*=e^{1/n}$$
        </div>
        <p class="body-text"><strong>7,936</strong> symmetry trials, <strong>64</strong> independent optimizations, and <strong>15/15</strong> malformed-geometry controls pass.</p>
        <table class="result-table mt-3">
          <thead><tr><th>Certificate</th><th>Cases</th><th>Worst error</th></tr></thead>
          <tbody>
            <tr class="ours"><td class="method">Eq. 18 Gram</td><td class="best">31</td><td>9.75e-16</td></tr>
            <tr><td class="method">Eq. 19 frame</td><td>31</td><td>1.55e-15</td></tr>
            <tr><td class="method">Scale optimum</td><td>64</td><td>4.44e-8</td></tr>
          </tbody>
        </table>
      </div>

      <div class="card" data-measure-role="card" data-logbook-target="claim-5-cross-modal-benchmarks">
        <div class="section-title"><span class="num">4</span><span class="st-text">C5 &mdash; benchmark identity falsified</span></div>
        <p class="body-text">
          The anchored claim calls 85.97 mIoU a ModelNet40 segmentation result. Both released training and test entrypoints instead load ShapeNetPart, use 16 object categories and 50 part labels, and calculate part IoU.
        </p>
        <p class="body-text mt-3">The separate ModelNet40 path performs 40-way <strong>classification</strong>; it cannot produce the reported instance-average part mIoU. The release also has zero SemanticKITTI files.</p>
        <div class="callout emph">
          <strong>Decisive result.</strong> ShapeNetPart &ne; ModelNet40. One false benchmark identity falsifies this conjunctive claim as written; Kinetics and SemanticKITTI remain untested.
        </div>
      </div>

      <div class="card highlight" data-measure-role="card" data-logbook-target="claim-6-ablations-and-computational-cost">
        <div class="section-title"><span class="num">5</span><span class="st-text">Unresolved empirics and audit record</span></div>
        <p class="body-text text-secondary fs-3 mb-2">
          Apple M2 CPU; pinned source; no checkpoint, dataset, paid compute, or hidden table substitution.
        </p>
        <div class="keybox">
          <div class="kb-item"><div class="kb-num nowrap">20/20</div><div class="kb-label">tests<br>passing</div></div>
          <div class="kb-item"><div class="kb-num nowrap">154</div><div class="kb-label">source<br>files audited</div></div>
          <div class="kb-item"><div class="kb-num nowrap">0</div><div class="kb-label">released<br>checkpoints</div></div>
        </div>
        <div class="callout mt-4">
          C3 and C4 need the unreleased trained ImageNet models. Empirical C6 needs ablation checkpoints or full retraining; table arithmetic alone is not reproduction.
        </div>
        <p class="body-text text-secondary fs-3 mt-3">Image width: 396 vs 384; Table 8: +6% FLOPs and parameters.</p>
        <p class="body-text text-secondary fs-3 mt-3">Four A100s cost $10/hour; no paid job was launched.</p>
      </div>
  ...
  <section class="takeaways-strip" data-measure-role="footer-strip">
    ...
    <div class="ts-title"><span class="num">6</span> Reproduction ledger</div>
    <div class="ts-item"><span class="ts-key">Fourier.</span><span class="ts-text">Translation identity and Parseval chain verify.</span></div>
    <div class="ts-item"><span class="ts-key">Geometry.</span><span class="ts-text">Simplex symmetry and $e^{1/n}$ optimum verify.</span></div>
    <div class="ts-item"><span class="ts-key">Identity.</span><span class="ts-text">ShapeNetPart is not ModelNet40.</span></div>
    <div class="ts-item"><span class="ts-key">Limits.</span><span class="ts-text">No checkpoint means no exact accuracy claim.</span></div>
  </section>
  ...
  <div class="footer" data-measure-role="footer">
    <div>
      <strong class="method-name">nD-RoPE reproduction and source audit</strong> &middot; ICML 2026 &middot;
      Apple M2 CPU &middot; captured runs in seconds &middot; $0
    </div>
    <div>
      Source: <span class="repo">github.com/BoyangL1/nD-RoPE @ f2cae707</span>
    </div>
  </div>

  <!-- OPTIONAL identity accessory (Axis 8): faint corner watermark. OFF by
       default -- the same corner mark on every poster is a fingerprint.
       Enable (uncomment + reword) only when the locked direction calls for it:
