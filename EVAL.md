...
| 5 | FALSIFIED_AS_WRITTEN | released 85.97-mIoU path is ShapeNetPart, not ModelNet40 |
| 6 | FALSIFIED_AS_WRITTEN | exact 224x224 models dynamically profiled; 5.69% extra attention MACs are caused by width 396 vs 384, while frequency directions contain zero trainable parameters |
